		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#smarttableamarttable1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smarttableamarttable1-display": {
								"semanticObject": "smarttableamarttable1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smarttable.amarttable1",
									"url": sap.ui.require.toUrl("smarttable/amarttable1")
								}
							}
						}
					}
